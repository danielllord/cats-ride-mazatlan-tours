...
function Index() {
  ...
  return <main id="home"><Header />
    ...
    <section className="grid overflow-hidden md:grid-cols-2"><div className="ocean-wash flex min-h-96 items-center px-6 py-16 text-primary-foreground md:px-[10vw]"><div><Sparkles className="mb-5 h-10 w-10 text-sunshine" /><h2 className="text-4xl md:text-5xl">Custom Tours for<br />Your Interests</h2><p className="mt-6 max-w-xl text-lg leading-8 text-primary-foreground/85">Enjoy time for lunch, optional tequila tasting, colorful Mazatlán stops, beaches, sightseeing, shopping, and plenty of opportunities for photos. Your itinerary can be customized around your interests and available time.</p></div></div><div className="sunset-wash grid min-h-96 overflow-hidden lg:grid-cols-[.82fr_1.18fr]"><div className="flex items-center px-6 py-12 lg:pl-10 lg:pr-7"><div><GlassWater className="mb-5 h-10 w-10 text-primary" /><h2 className="text-4xl text-primary md:text-5xl">Sip, Relax & Enjoy</h2><p className="mt-6 max-w-xl text-lg leading-8 text-primary/80">We also offer drinks including water, sodas, Pacifico beer and local tequila.</p></div></div><img src={drinksImage} alt="Cooler filled with bottled water, iced Coca-Cola, Pacifico beer, and local tequila on a Mazatlán beach" width="1536" height="1024" loading="lazy" className="h-72 w-full object-cover lg:h-full lg:min-h-0" /></div></section>

    <section id="booking" className="bg-background py-16 md:py-24"><div className="mx-auto grid max-w-7xl gap-12 px-5 md:grid-cols-[.75fr_1.25fr] md:px-8"><div><p className="mt-6 text-lg leading-8 text-muted-foreground">Tell us about your visit and Martin will get back to you with tour information and a quote.</p><div className="mt-10 space-y-5"><a href="tel:+016691647788" className="flex items-center gap-4 font-bold text-primary"><span className="rounded-full bg-sunshine p-3"><Phone /></span><span><small className="block text-muted-foreground">PHONE</small>+01 6691647788</span></a><a href="mailto:bookings@catsridemazatlan.com" className="flex items-center gap-4 break-all font-bold text-primary"><span className="rounded-full bg-ocean p-3 text-ocean-foreground"><Mail /></span><span><small className="block text-muted-foreground">EMAIL</small>bookings@catsridemazatlan.com</span></a><a href={facebookUrl} target="_blank" rel="noreferrer" className="flex items-center gap-4 font-bold text-primary"><span className="rounded-full bg-primary p-3 text-primary-foreground"><Facebook /></span><span><small className="block text-muted-foreground">FACEBOOK</small>Cat’s Ride Mazatlan</span></a></div></div><div className="rounded-lg border border-border bg-secondary p-5 shadow-xl sm:p-8"><BookingForm /></div></div></section>
